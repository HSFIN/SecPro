...
<body class="index-body">
    ...
    <div class="recipe-of-the-week-separator">
            ...
            <span class="date-indicator"><?php echo e(date('d/m')); ?></span>
        </div>

        <section class="recipe-of-the-week">
            <div class="recipe-row">
                <?php $__currentLoopData = $weeklyRecipes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="recipe-highlight">
                    
                    <img src="<?php echo e(asset($recipe['image'])); ?>" alt="<?php echo e($recipe['title']); ?>" class="highlight-image">
                    <div class="highlight-info">
                        <h3><?php echo e($recipe['title']); ?></h3>
                        <p class="recipe-snippet"><?php echo e($recipe['description']); ?></p>
                        <a href="<?php echo e(url($recipe['link'])); ?>" class="read-more-button">Read More</a>
                    </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\secprog\SecPro\FrontEndSec\resources\views/mainPage.blade.php ENDPATH**/ ?>